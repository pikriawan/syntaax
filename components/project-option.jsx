...
export default function ProjectOption({ publicId, name }) {
    ...
    return (
        <>
            ...
            <Modal open={open} onClose={() => setOpen(false)} className="p-0 top-1/2 -translate-y-1/2">
                <div className="p-0 flex flex-col items-center">
                    ...
                    <button className="w-full py-2 text-red-500" onClick={() => {
                        setOpen(false);
                        setDeleteOpen(true);
                    }}>
                        Delete
                    ...
                    />
                    <div className="w-full h-[0.0625rem] bg-zinc-800" />
                    <button className="w-full py-2" onClick={() => setOpen(false)}>Cancel</button>
                </div>
            </Modal>
        </>
    );

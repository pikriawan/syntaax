...
export default async function ProjectList() {
    ...
    return projects?.length ? projects.map((project) => (
        <div key={project.public_id} className="bg-zinc-950 shadow-[0_0_0_0.0625rem_#27272A_inset] p-4 rounded-lg relative hover:bg-zinc-900">
            <Link href={`/project/${project.public_id}`} className="flex flex-col gap-4">
